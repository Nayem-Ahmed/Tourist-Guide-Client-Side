                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white rounded-lg shadow-md flex flex-col">
                            ...
                            <div className="p-4 flex-grow">
                                <h2 className="blog-title text-xl font-semibold mb-2">10 Must-Visit Destinations for Adventure Seekers</h2>
                        ...
                        <div className="bg-white rounded-lg shadow-md flex flex-col">
                            ...
                            <div className="p-4 flex-grow">
                                <h2 className="blog-title text-xl font-semibold mb-2">Exploring Hidden Gems: Off-the-Beaten-Path Destinations</h2>
